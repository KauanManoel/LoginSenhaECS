...
using LoginSenha.CrossCutting.ExceptionHandler.Extensions;
...
using Profile = LoginSenha.Domain.Entities.Profile;
...
namespace LoginSenha.Application.Services
{
    public class UserService : IUserService
    {
        ...
        public bool ChangePassword(UserRequestChangePasswordViewModel user)
        {
            ...
            emailSender.SendEmailAsync(new EmailViewModel(new string[] { _user.Email }, "Change Password - LoginSenha", "PASSWORD-CHANGED"), new string[] { _user.Name });
        ...
        public bool Post(UserRequestCreateAccountViewModel user, string host)
        {
            ...
            try
            {
                ...
                emailSender.SendEmailAsync(new EmailViewModel(new string[] { _user.Email }, "Account Created - LoginSenha", "ACCOUNT-CREATED"), new string[] { _user.Name, _generateUrlEmail });
