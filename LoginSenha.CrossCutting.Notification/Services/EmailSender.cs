...
namespace LoginSenha.CrossCutting.Notification.Services
{
	...
	"Please, activate it in the link below: {1}<br/><br/><b>LoginSenha</b>",
				"FORGOT-PASSWORD" => "Hi {0} <br/><br/> The code to change the password is: <b>{1}</ b><br/><br/><b>LoginSenha</b>",
				"PASSWORD-CHANGED" => "Hi {0} <br/><br/> Your password has been changed successfully.<br/><br/><b> LoginSenha </b> ",
				_ => "",
			};
		}
		...
		private MimeMessage CreateEmailMessage(EmailViewModel message, IEnumerable<string> parameters)
		{
			...
			emailMessage.From.Add(new MailboxAddress("LoginSenha", _emailConfig.From));
