...
using LoginSenha.CrossCutting.Auth.Providers;
using LoginSenha.CrossCutting.ExceptionHandler.Providers;
using LoginSenha.CrossCutting.IoC;
using LoginSenha.CrossCutting.Notification.ViewModels;
using LoginSenha.CrossCutting.Swagger;
